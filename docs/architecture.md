...
- `play-room-protocol` owns the network message schema and JSON-lines codec.
- `play-room-server` owns TCP sockets, sessions, room registry, broadcast fanout, reconnect tokens, and timers.
