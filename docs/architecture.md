...
Room membership is tied to player identity, not the transport connection. A disconnected participant may remain in a room so they can reconnect without losing score or role.
